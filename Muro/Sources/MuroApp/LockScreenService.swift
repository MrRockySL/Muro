...
final class LockScreenService {
    ...
    func apply(
        ...
        if rotation { nextState.rotation = storeID }
    ...
    /// staged step, and put back the wallpaper that was showing before it
    /// started. Just today's `remove` path for the desktop role.
